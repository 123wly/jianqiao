...
<div id="right_xf">
    <ul>
        ...
        <li class="hdzs"><a target="_blank" href="<?php echo spUrl('life','',array('tid'=>'20'));?>" title="活动展示"><span>活动展示</span></a></li>
    ...
    <div class="foot_top">
         <p>
            <?php 
                ...
                $footId = $foot["id"];
                $foot = spClass("db_ad_list")->findAll(array("auid"=>$footId,"is_show"=>1));
                // var_dump($foot);
             ?>
