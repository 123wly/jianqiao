    	...
    	<div class="main top_nav">
            ...
            <div class="nav">
            	<ul>
                	...
                	<li class="<?php echo $nav_class[$key];?>">
                        <a <?php echo $root==$vo['id'] ? 'class="hover"' : ''; ?> href="<?php echo spUrl($vo['tpl'],'',array('tid'=>$vo['id']));?>">
                            
                            <img src="<?php echo $skin_path; ?>images/nav/<?php echo str_replace(" ","_",strtolower($vo["en_name"])); ?>.png" />
                            <span></span>
                        </a>
                    </li>  
                    <?php endforeach ?> 
